...
>(
  (
    ...
    React.useEffect(() => {
      ...
      if (savedState) {
        setOpen(savedState.split('=')[1] === 'true');
      }
    }, [setOpen]);
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'group/sidebar hidden md:flex flex-col text-sidebar-foreground bg-sidebar h-screen',
